#!/bin/bash
# Script to run ScanObjectNN feature extraction
...
BATCH_SIZE=32
DEVICE="cuda"
OUTPUT_DIR="scanobjectnn_feature_cache"
LOG_FILE="scanobjectnn_extraction.log"

echo "=================================================="
echo "Starting ScanObjectNN Feature Extraction"
echo "=================================================="
...
echo "Starting extraction at $(date)" | tee -a "$LOG_FILE"
